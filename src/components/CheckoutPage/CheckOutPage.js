            ...
            <Container>
                ...
                {!validation
                    ? <div className="alert alert-danger ">
                        ...
                        {shipping ? <div>
                            {test ? !test.shipping_first_name ? <div> shipping firstName is a required field.</div> : null : null}
                            {test ? !test.shipping_last_name ? <div> shipping LastName is a required field.</div> : null : null}
                            {test ? !test.shipping_address_1 ? <div> shipping Streetaddress is a required field.</div> : null : null}
                            {test ? !test.shipping_ciy ? <div> shipping City is a required field.</div> : null : null}
                            {test ? !test.shipping_postcode ? <div> shipping Pincode is a required field.</div> : null : null}
                            {test ? !test.shipping_country ? <div> shipping Country is a required field.</div> : null : null}
                            {test ? !test.shipping_state ? <div> shipping State is a required field.</div> : null : null}
